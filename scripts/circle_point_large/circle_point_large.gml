...
function circle_point_large(xx, yy, spd){
	var point_move_x = xx + lengthdir_x(90 + floor(random(8)),orbit_angle)
	var point_move_y = yy + lengthdir_y(90 + floor(random(8)), orbit_angle)
